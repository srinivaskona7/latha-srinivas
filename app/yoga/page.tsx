...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "Stay well hydrated and avoid overheating &mdash; skip hot or heated-room yoga entirely.",
      "Avoid deep twists, strong abdominal/core work, and any inversions or balancing on the head.",
      "From about 16&ndash;20 weeks, avoid lying flat on your back for long &mdash; use a side-lying or propped position.",
  ...
  },
  {
    ...
    title: "Trimester 1 &mdash; keep it gentle",
    ...
    tips: [
      ...
      "Skip new, vigorous routines &mdash; this is a time to settle into a calm rhythm.",
    ],
  },
  {
    eyebrow: "Second trimester",
    title: "Trimester 2 &mdash; often the most comfortable",
  ...
  },
  {
    ...
    title: "Trimester 3 &mdash; hips, breath, and rest",
  ...
  },
  {
    ...
    body: "Slow, gentle breathing is one of the most useful tools in pregnancy &mdash; it settles the mind and helps you stay present. Keep it soft and natural, and never hold the breath or force it.",
    tips: [
  ...
  },
  {
    ...
    body: "Some conditions make yoga and exercise unsafe unless a doctor guides you closely. If any of the situations below apply, do not practise on your own &mdash; talk to your obstetrician first.",
    tips: [
      "Placenta praevia, a risk of preterm labour, or pre-eclampsia &mdash; only under medical guidance.",
  ...
  },
  {
    ...
    body: "Yoga isn&apos;t the only gentle option. Simple, steady activity most days &mdash; with your clinician&apos;s okay &mdash; supports your strength and comfort through pregnancy.",
    tips: [
    ...
    <main className="mx-auto w-full max-w-4xl px-5 py-12 sm:px-8 sm:py-16">
      <SectionReveal>
        <header className="mb-10">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted">
            ...
            trimester-wise guide to safe asanas, calming pranayama, and other gentle exercise &mdash; always with your
      ...
      <SectionReveal delay={0.15}>
        <p className="mt-8 text-center text-xs leading-relaxed text-muted">
          ...
          &mdash; clear any exercise or yoga practice with your obstetrician, and stop and seek help if you feel unwell.
